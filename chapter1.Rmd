...
## Question 3
Open the `R Markdown file` that corresponds to this exercise. The `file` titled `lab1_ex3.Rmd` can be found in the lower right quadrant. 

You can use the RStudio platform just like you would on your home computer. 

<strong>Follow the directions and instructions in the markdown file, but answer the exercise below.<strong>
