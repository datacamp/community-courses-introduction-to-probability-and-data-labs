...
success_msg("Click [here](https://assets.datacamp.com/production/course_1156/datasets/ch1_key.Rmd) to get a complete Rmarkdown file of the exercises in this Lab and click [here](https://assets.datacamp.com/production/course_1156/datasets/ch1_key.html) to get the Knitted HTML output.")
```
