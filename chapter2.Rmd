...
ex() %>% check_mc(3, feedback_msgs = c(msg1, msg2, msg3, msg4, msg5))
success_msg("Click [here](https://assets.datacamp.com/production/course_1156/datasets/ch2_key.Rmd) to get a complete Rmarkdown file of the exercises in this Lab and click [here](https://assets.datacamp.com/production/course_1156/datasets/ch2_key.html) to get the Knitted HTML output.")
```
